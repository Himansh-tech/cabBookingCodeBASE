...
public class Driver {
    ...
    @Column(nullable = false, unique = true) //licenseNumber unique identifier across services
    ...
    public LocalDateTime getLastRatedAt() { return lastRatedAt; }
    public String getRatingComments() { return ratingComments; }

    // NEW SETTERS
    public void setAvgRating(Double avgRating) { this.avgRating = avgRating; }
    public void setRatingCount(Integer ratingCount) { this.ratingCount = ratingCount; }
    public void setLastRatedAt(LocalDateTime lastRatedAt) { this.lastRatedAt = lastRatedAt; }
    ...
    public String toString() {
        return "Driver{" +
                ...
                // Do not include large LOB fields in toString to keep logs clean
                '}';
    }
}