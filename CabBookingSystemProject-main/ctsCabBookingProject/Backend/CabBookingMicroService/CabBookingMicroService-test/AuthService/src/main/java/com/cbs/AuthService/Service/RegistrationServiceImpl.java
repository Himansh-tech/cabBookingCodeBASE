...
public class RegistrationServiceImpl implements RegistrationService {
        ...
        try {
            ...
            if (responseFromUser.getData() != null && responseFromUser.getData().getId() != null
                ...
                return new ApiResponseDto<>("User registration failed: " + responseFromUser.getMessage(),
                        responseFromUser.getStatus(), LocalDateTime.now(), null); // Use UserService's status if available
            }
            ...
            if (savedAuthEntity != null && savedAuthEntity.getId() != -1l) {
                authRepository.delete(savedAuthEntity); // Clean up
            }
            System.out.println("Inside catch Block (AuthService - DataIntegrityViolation)");
    ...
    // com.cbs.AuthService.Service.AuthServiceImpl (or wherever registerDriver is)
